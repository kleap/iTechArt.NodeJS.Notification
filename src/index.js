...
const store = createStore(combineReducers({users: userReducer, router: routerReducer, dashboard: dashboardReducer, notification: notificationReducer}), {
  users: {
    isAuth: isAuth(),
    errors: {}
  },
